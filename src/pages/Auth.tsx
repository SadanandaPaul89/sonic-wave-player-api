  ...
  const handleSignInWithGoogle = async () => {
    ...
    try {
      ...
      if (isUsingLocalAuth()) {
        ...
        console.log('Initiating Supabase OAuth with redirect URL:', redirectUrl);
  ...
  if (isMobile) {
    return (
      <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
        ...
        <div>
          <div className="w-full max-w-sm bg-white/95 backdrop-blur-lg shadow-2xl border border-white/20 relative z-10 rounded-lg">
            <div className="p-6">
              ...
              <form onSubmit={activeTab === 'login' ? handleEmailSignIn : handleEmailSignUp} className="space-y-6">
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="w-full h-12 border-gray-300 bg-gray-50 hover:bg-gray-50 transition-none text-gray-700"
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-4xl mx-auto relative z-10">
        <div>
          <div className="overflow-hidden bg-white/80 backdrop-blur-lg shadow-2xl border border-white/20 rounded-lg">
